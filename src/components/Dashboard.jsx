...
export default function Dashboard() {
  ...
  return (
    <>
    {dashBoardLoading ? <div className="h-full w-full absolute justify-center gap-2 items-center flex " >
      <svg
                ...
                <h1>Loading...</h1>
    </div>   :   <div className="grid grid-cols-10 items-center mx-auto">
        ...
        <div className="flex justify-around flex-row lg:flex-col">
          <div>
            {recentTransactions.map((transaction, index) => (
              ...
              >
                <h1 className={ transaction.x == 'e' ? ' text-red-500 mr-[30px] md:mr-[100px] lg:mr-0 '  : 'mr-[30px] md:mr-[100px] lg:mr-0'}>{
                ...
                transaction.x == 'e' ? <span className="text-red-500" > - ${transaction.amount}</span> : <span>  ${transaction.amount}</span>  
